...
import { Button, FoodListItem, Header, ItemValue } from '../../components'
    ...
    return (
       <ScrollView>
            ...
            <View style={styles.button}>
                <Button color={'green'} textColor={'white'} text={'Transaction Sekarang'} onPress={() => navigation.replace('SuccessOrder')}/>
            </View>
        </ScrollView>
    )
}
